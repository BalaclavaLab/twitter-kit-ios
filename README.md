...
```swift
binary "https://raw.githubusercontent.com/BalaclavaLab/twitter-kit-ios/4.0.0/TwitterCore.json"
binary "https://raw.githubusercontent.com/BalaclavaLab/twitter-kit-ios/4.0.0/TwitterKit.json"
```
